...
const cards = () => {
    return (
        <div className='md:h-screen h-[1100px] w-full'>
            ...
            <div>
                <div className='align-middle pt-20'>
                    ...
                    <div className='w-3/4 md:w-1/2 flex md:flex-row flex-col justify-center mx-auto space-y-20 md:space-x-20 space-x-0 md:space-y-0'>
                        <div>
                            <div class="md:min-h-[610px] max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 z-100">
